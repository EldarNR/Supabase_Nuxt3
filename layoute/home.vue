<template>
    <div class="container my-3 bg-white">
        <div class="flex isolate px-6 pt-14 lg:px-8">
            ...
            <div class="w-1/2 py-5  float-right">

                <div class="text-center flex items-center justify-center">

                    <img src="https://i0.wp.com/thesefourwallsblog.com/wp-content/uploads/2019/03/Hallway-makeover-13.jpg?resize=624%2C906&ssl=1"
